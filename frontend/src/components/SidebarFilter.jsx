  ...
  return (
    <div className="relative flex">
      ...
      <button 
        ...
        className="absolute -left-8 top-8 bg-gray-700 hover:bg-gray-600 p-2 rounded-l-md shadow-md z-10"
      >
        <CollapseIcon />
      </button>
      
      <div className={`sidebar-filter bg-gray-800 text-white p-4 rounded-lg shadow-lg transition-all duration-300 ${collapsed ? 'w-0 p-0 overflow-hidden opacity-0' : 'w-full opacity-100'}`}>
...
{/* Price Range Filter - Simplified version */}
<div className="mb-4 border-b border-gray-700 pb-3">
  <SectionHeader
    title="Price Range (₹)"
    icon={
  ...
  {sections.price && (
    <div className="mt-2">
      ...
      {/* Simple slider like in reference image */}
      <div className="mb-4 px-2">
        ...
        {/* Bottom apply filter button removed as requested */}
      </div>
    </div>
  );
};
